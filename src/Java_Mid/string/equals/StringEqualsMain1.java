package Java_Mid.string.equals;
...
public class StringEqualsMain1 {
    public static void main(String[] args) {
        ...
        System.out.println("new Strijng() Java_Basic.equals 비교: " + (str1.equals(str2)));
        ...
        System.out.println("리터럴 Java_Basic.equals 비교: " + (str3.equals(str4)));
